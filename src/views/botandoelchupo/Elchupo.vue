      ...
      <div class="row">
        <div class="col-md-8 editor">
          ...
          <br>
            ...
            <b-btn variant="link" :to="{name:'chupo', params: {id: Plastilina._id}}" style="color:#000;"><h4 class="tittle">{{Plastilina.titulo}}</h4> </b-btn> 
            <br/>                   
            <p class="texto" style="font-family: 'Special Elite', cursive;">{{Plastilina.parrafoUno}} <b-btn variant="link" :to="{name:'chupo', params: {id: Plastilina._id}}" style="color:#000;">[[Leer mas...]]</b-btn> </p>        
