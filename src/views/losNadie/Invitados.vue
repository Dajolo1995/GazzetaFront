<template>
    <div class="container editorial">
        ...
        <div class="ccol-md-12">
            <div class="">
                <b-button v-b-modal.modal-43 variant="outline-info" >Informacion</b-button>
                    <b-modal id="modal-43" title="Información   " >
                        <p class="my-4">Tienes una columna de opinion y no tienes donde publicarlo </p>
            ...
            <div class="row">
                <div class="col-md-12 editor">
                    <div class="tex">
                        ...
                        <p class="texto">{{Chupo.parrafo}}</p>
                        <p class="texto">{{Chupo.parrafoDos}}</p>
                        <p class="texto">{{Chupo.parrafoTres}}</p>
                        <p class="texto">{{Chupo.parrafoCuatro}}</p>
                        <p class="texto">{{Chupo.parrafoCinco}}</p>
                        <p class="texto">{{Chupo.parrafoSeis}}</p>
                        <p class="texto">{{Chupo.parrafoSiete}}</p>
                        <p class="texto">{{Chupo.parrafoOcho}}</p>
                        <p class="texto">{{Chupo.parrafoNueve}}</p>
                        <p class="texto">{{Chupo.parrafoOnce}}</p>                                                                       
                        <strong class="nombre">{{Chupo.autor}}</strong>
